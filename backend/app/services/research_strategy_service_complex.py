...
class ResearchStrategyService:
    ...
    def __init__(self):
        self.ai_service = SimpleAIOrchestrator()
    ...
    async def _analyze_market_context(
        ...
        response = await self.ai_service.research_topic(
            idea_title, research_type="market_context"
        )
    ...
    async def _analyze_competitive_intelligence(
        ...
        response = await self.ai_service.research_topic(
            idea_title, research_type="competitive_intelligence"
        )
    ...
    async def _analyze_customer_understanding(
        ...
        response = await self.ai_service.research_topic(
            idea_title, research_type="customer_understanding"
        )
    ...
    async def _conduct_strategic_assessment(
        ...
        response = await self.ai_service.research_topic(
            idea_title, research_type="strategic_assessment"
        )
    ...
    async def _generate_strategic_options(
        ...
        response = await self.ai_service.research_topic(
            idea_title, research_type="strategic_options"
        )
