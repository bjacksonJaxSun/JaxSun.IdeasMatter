#!/usr/bin/env python3
"""
Minimal authentication server for testing
...
def start_auth_server(port=8000):
    """Start the minimal auth server"""
    with socketserver.TCPServer(("", port), AuthHandler) as httpd:
        print(f"🚀 Minimal Auth Server starting on http://localhost:{port}")
